...
class CurrencyFormatter {
  String format(amount,
    ...
    if (compact) {
      final Map<num, String> letters = {pow(10, 9): 'B', pow(10, 6): 'M', pow(10, 3): 'K'};
      ...
      for (int i = 0; i < letters.length; i++) {
        ...
        parsedAmount = amount.toStringAsPrecision(3) + letter;
      }
    } else {
      parsedAmount = amount.toStringAsFixed(decimal);
    }
    String number = parsedAmount!.replaceAll('.', settings.decimalSeparator!);
  ...
  CurrencyFormatterSettings? getLocal() =>
      getFromSymbol(NumberFormat
